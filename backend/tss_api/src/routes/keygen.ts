...
import type { KeygenBody, KeygenBodyV2 } from "@oko-wallet/oko-types/tss";
import { ErrorCodeMap } from "@oko-wallet/oko-api-error-codes";
import type { OkoApiResponse } from "@oko-wallet/oko-types/api_response";
import type { SignInResponse, SignInResponseV2 } from "@oko-wallet/oko-types/user";
...
import { runKeygen, runKeygenV2 } from "@oko-wallet-tss-api/api/keygen";
import {
...
export function setKeygenRoutes(router: Router) {
  ...
  registry.registerPath({
    ...
    responses: {
      200: {
        description: "Successfully created user and wallet entities for both curve types",
        content: {
          "application/json": {
